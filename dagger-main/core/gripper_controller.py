"""
夹爪异步控制器（复制自 dagger/deps/gripper_controller.py → dagger/core/）

Phase 2B: 移至 core/ 与 udp_state.py、data_recorder.py 统一管理。
...
class GripperAsyncController:
    ...
    def send_async(self, position: int):
        ...
        try:
            ...
            logger.warning("[Gripper] 命令队列满，丢弃夹爪指令 position=%d", position)
